rm(list=ls())
library(pROC)
training<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/All Features/Oversampled_Diabetes_Dataset_Train80p.csv")
...
roc_obj<-roc(testing[,17],as.numeric(testing$predict))
rocauc<-auc(roc_obj)
