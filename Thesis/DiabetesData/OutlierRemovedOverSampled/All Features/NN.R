library(neuralnet)
library(pROC)
#trainDF<-read.csv("E:/MSc/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Diabetes_Dataset_Train80p.csv")
#testDF<-read.csv("E:/MSc/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Diabetes_Dataset_Test20p.csv")
trainDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/All Features/Oversampled_Diabetes_Dataset_Train80p.csv")
testDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/All Features/Diabetes_Dataset_Test20p.csv")
...
PredictionsWithClass <- compute(neuralModel,testDF[,1:16]) 
