library(neuralnet)
library(pROC)
trainDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/RFE-RF/Top6/Diabetes_Dataset_Train80p.csv")
testDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/RFE-RF/Top6/Diabetes_Dataset_Test20p.csv")
