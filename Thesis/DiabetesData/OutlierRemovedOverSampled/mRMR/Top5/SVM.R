rm(list=ls())
training<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/mRMR/Top5/SMOTEOversampled_Diabetes_Dataset_Train80p.csv")
testing<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/mRMR/Top5/Diabetes_Dataset_Test20p.csv")

sapdata<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/mRMR/Top5/Sap_SVM_Selected.csv")

seedarray <- c(124,640,456,970,950,880)
...
for(i in 1:length(seedarray)){
  ...
  #y_pred<-round(y_pred)
  cm=table(y_pred,testing[,6],dnn=c("Prediction","Actual"))
  ...
  roc_obj<-roc(testing[,6],as.numeric(y_pred))
  rocauc<-auc(roc_obj)
...
write.csv(sapdata,"C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/mRMR/Top5/Sap_SVM_Selected.csv")
