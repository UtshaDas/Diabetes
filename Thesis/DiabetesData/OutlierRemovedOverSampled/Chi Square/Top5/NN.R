library(neuralnet)
library(pROC)
trainDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/Chi Square/Top5/Oversampled_Diabetes_Dataset_Train80p.csv")
testDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemovedOverSampled/Chi Square/Top5/Diabetes_Dataset_Test20p.csv")
...
PredictionsWithClass <- compute(neuralModel,testDF[,1:5]) 
