...
library(pROC)
trainDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/All Samples/mRMR/Diabetes_Dataset_Train80p.csv")
testDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/All Samples/mRMR/Diabetes_Dataset_Test20p.csv")
...
PredictionsWithClass<- predict(modelRandom, testDF[,1:5], type = 'class')
