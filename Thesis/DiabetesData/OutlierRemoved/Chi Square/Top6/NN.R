library(neuralnet)
library(pROC)
trainDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Chi Square/Top6/Diabetes_Dataset_Train80p.csv")
testDF<-read.csv("C:/Users/BREB/OneDrive/Documents/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Chi Square/Top6/Diabetes_Dataset_Test20p.csv")
...
neuralModel<-neuralnet(formula=form, data=trainDF, hidden = c(8,4), threshold = 0.001,
