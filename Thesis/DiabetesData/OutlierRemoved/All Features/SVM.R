rm(list=ls())
training<-read.csv("E:/MSc/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Diabetes_Dataset_Train80p.csv")
testing<-read.csv("E:/MSc/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Diabetes_Dataset_Test20p.csv")

sapdata<-read.csv("E:/MSc/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Sap_SVM_Selected.csv")
...
write.csv(sapdata,"E:/MSc/MSc Thesis/Thesis/DiabetesData/OutlierRemoved/Sap_SVM_Selected.csv")
